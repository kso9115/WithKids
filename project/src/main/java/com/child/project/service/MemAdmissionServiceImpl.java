...
public class MemAdmissionServiceImpl implements MemAdmissionService {
    ...
    public List<Member> findSearch(Member entity) {
        ...
        // return memRepository.findSearch(entity.getMemStr(), entity.getMemStr(),
        // entity.getMemName() , entity.getMemResPerson() , entity.getMemStatus());
        return memRepository.findSearch(entity.getMemStr(), entity.getMemEndF(), entity.getMemName(),
                entity.getMemResPerson(), entity.getMemStatus());
    }
