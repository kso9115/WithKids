...
public interface StaffRepository extends JpaRepository<Staff, String> {
        ...
        @Query("SELECT new com.child.project.domain.StaffDTO(a.staffPst,a.staffNm,a.staffId,a.staffPsw,a.staffPhnn,a.staffLeave,a.staffLvdy,a.rmr,"
                        + "b.staffChlCr,b.staffCmnMng,b.staffCntMng) FROM Staff a LEFT JOIN StaffPrv b ON a.staffPst=b.staffPst WHERE a.staffId=:staffId")
        StaffDTO findJoinOne(@Param("staffId") String staffId);
