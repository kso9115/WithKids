...
public class Criteria {
	private int rowPerPage; // 1Page에 출력할 row 개수
	private int currPage; // 현재 출력(요철) Page
	private int sno; //start Row 순서번호: 개산필요
	private int eon; //end Row 순서번호: 개산필요(오라클만 필요) 리밋
