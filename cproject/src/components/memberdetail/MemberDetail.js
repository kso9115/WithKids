...
function MemberDetail({ data, setData }) {
    ...
    function saveMemDate() {
        ...
        axios.post('/api/mem/memInesert', null, {
        ...
        <form onSubmit={handleSubmit}>
            <div>
                ...
                <div className='mem_gridBox3'>
                    ...
                    <div>학교명</div>
                    <div><input type='text' name='education_name' defaultValue='컬럼추가'></input></div>

                    <div>학년(반)</div>
                    <div><input type='text' name='education_grade' defaultValue='컬럼추가'></input></div>

                    <div>담임명</div>
                    <div><input type='text' name='education_teacher' defaultValue='컬럼추가'></input></div>

                    <div>담임연락처</div>
                    <div><input type='tel' name='education_teacherPhone' defaultValue='컬럼추가'></input></div>
                ...
                <div className='buttonBox'>
                    <div>
                        ...
                        <button type="submit" defaultValue='신규' onClick={() => saveMemDate()}>신규</button>
                        <button type="submit" defaultValue='저장' >저장</button>
                    </div>
                </div>
            </div >
        </form >
