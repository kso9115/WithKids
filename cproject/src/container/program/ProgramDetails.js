        ...
        <div style={{
            ...
            <form action='asd' method='get'>
                ...
                <div className='prg_dtl_gridBox'>
                    ...
                    <div><input type="text" name='prg_mid_cls'/></div>

                    <div><span>*</span>사업 소분류</div>
                    <div><input type="text" name='prg_sub_cls' /></div>

                    <div><span>*</span>프로그램 구분</div>
                    <div className='radioBox'>
                        <div>
                            <input type="radio" id='interior' name='prg_cls' value='내부형프로그램' checked />
                            <label for='interior'>내부형프로그램</label>
                        </div>
                        <div>
                            <input type="radio" id='application' name='prg_cls' value='신청형프로그램' />
                            <label for='application'>신청형프로그램</label>
                        </div>
                    </div>

                    <div><span>*</span>프로그램명</div>
                    <div><input type="text" name='prg_nm' /></div>

                    <div>서비스 분류</div>
                    <div><input type="text" name='prg_svc' /></div>

                    <div><span>*</span>프로그램 기간</div>
                    <div><input type="date" name='prg_str' /> ~ <input type="date" name='prg_end' /></div>

                    <div><span>*</span>담당자</div>
                    <div><input type="text" name='prg_mngr' /></div>

                    <div><span>*</span>담당자 전화번호</div>
                    <div><input type="tel" name='prg_mngr_phnn' /></div>

                    <div><span>*</span>담당자 이메일</div>
                    <div><input type="email" name='prg_mngr_eml' /></div>

                    <div><span>*</span>지원횟수</div>
                    <div><input type="text" name='prg_nmb_api' /></div>

                    <div><span>*</span>사용여부</div>
                    <div className='radioBox'>
                        <div><input type="radio" id='yes' name='prg_use' value='Y' checked /><label for='yes'>Y</label></div>
                        <div><input type="radio" id='no' name='prg_use' value='N' /><label for='no'>N</label></div>
                    </div>
