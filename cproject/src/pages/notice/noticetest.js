...
function Notice() {
    // 이벤트 핸들러 함수 정의
    const handleOpMovePage = (pageNumber) => {
        // 페이지 이동 로직을 여기에 구현
        ...
        <div id="container" className="sub">
                            ...
                            <tr>
                                <th scope="row">
                                    <div className="input_group">
                                        <select title="구분" id="q_searchKey" name="q_searchKey" className="searchKey">
                                ...
                                <td>
                                    <div className="input_group">
                                        ...
                                        <span className="input_addon">
                                            <button type="submit" className="btn_bbs_search">검색</button>
                                        </span>
                                    </div>
                                </td>
                            </tr>
            ...
            <div className="con_inner">
                ...
                <div className="paging" id="page-div">
                    <strong>1</strong>
                    <a href="#2" onClick={() => handleOpMovePage(2)} title="2 페이지">2</a>
                    <a href="#3" onClick={() => handleOpMovePage(3)} title="3 페이지">3</a>
                    <a href="#4" onClick={() => handleOpMovePage(4)} title="4 페이지">4</a>
                    <a href="#5" onClick={() => handleOpMovePage(5)} title="5 페이지">5</a>
                    <a href="#6" onClick={() => handleOpMovePage(6)} title="6 페이지">6</a>
                    <a href="#7" onClick={() => handleOpMovePage(7)} title="7 페이지">7</a>
                    <a href="#8" onClick={() => handleOpMovePage(8)} title="8 페이지">8</a>
                    <a href="#9" onClick={() => handleOpMovePage(9)} title="9 페이지">9</a>
                    <a href="#10" onClick={() => handleOpMovePage(10)} title="10 페이지">10</a>
                    <a href="#next" className="direction next" onClick={() => handleOpMovePage(11)}
