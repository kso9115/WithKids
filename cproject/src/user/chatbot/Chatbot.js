...
const steps2 = [
    ...
    {
        id: "1",
        message: "안녕하세요, 저는 지역아동센터 쳇봇 이에요~ ^ㅡ^",
        trigger: "2",
    },
    {
        id: "2",
    ...
    /////////////////////////////////////////////////////////////////// 넓은 범위 카테고리 선택 확인 메시지
    {
        id: "4",
        options: [
            { value: "challenge", label: "공지사항", trigger: "5" },
            { value: "inbody", label: "프로그램 일정", trigger: "6" },
            { value: "calendar", label: "프로그램 목록", trigger: "7" },
        ],
    },
    {
        id: "5",
        message: "공지사항을 선택하셨습니다.",
        trigger: "8",
    },
    {
        id: "6",
        message: "프로그램 일정을 선택하셨습니다.",
        trigger: "9",
    },
    {
        id: "7",
        message: "프로그램 목록을 선택하셨습니다.",
        trigger: "10",
    },
];
